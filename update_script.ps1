# PowerShell script to update assets/script.js
Write-Output "Updating assets/script.js..."
...
[System.IO.File]::WriteAllText("$PWD\assets\script.js", $jsContent, [System.Text.Encoding]::UTF8)
Write-Output "assets/script.js updated successfully."
